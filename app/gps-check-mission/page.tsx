      ...
      <div className="mx-auto max-w-6xl px-6 py-10">
        ...
        <div className="mt-8 grid gap-6 lg:grid-cols-[minmax(0,1.35fr)_minmax(320px,0.65fr)]">
          ...
          <div className="space-y-6">
            ...
            <section className="rounded-[28px] border border-[#AFFF00]/50 bg-[#f4f9e9] p-6"><h2 className="text-xl font-bold">7. GPS Verification</h2><p className="mt-3 text-sm text-gray-700">You must be within 20 meters of the destination at the required time.</p><div className="mt-4 grid grid-cols-2 gap-3 text-sm"><div><div className="text-xs text-gray-500">Required Distance</div><strong>20 meters</strong></div><div><div className="text-xs text-gray-500">Required Time</div><strong>{startDateTime.toLocaleTimeString("th-TH", { hour: "2-digit", minute: "2-digit" })}</strong></div></div></section>
