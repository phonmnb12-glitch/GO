...
const socialPosts = [
  { handle: "@creativekatie", text: "ได้แรงบันดาลใจเสร็จตลอดทั้งเพลง ไม่พูดเลย เพลินมาก ทันใจมากที่สุด 🔥", likes: "2.4k" },
  { handle: "@fitnessjay", text: "ไม่มีน้ำตาลแต่พลังงานเต็ม  100% นี่แหละคือสิ่งที่ใช่", likes: "1.8k" },
  { handle: "@techbro_sam", text: "สุดท้ายแล้วที่ได้เครื่องดื่มแรงงานที่ไม่อยู่ที่ซักน้ำยา", likes: "956" },
]
