...
const activations = [
  {
    icon: Sparkles,
    title: "งานทดลองฟรี",
    description: "ชิมลองผลิตภัณฑ์ในงานดีๆ ใกล้บ้านคุณ",
    cta: "ดูงานทั้งหมด",
  },
  {
    icon: Dumbbell,
    title: "ฟิตเนส & สตูดิโอ",
    description: "ร่วมเป็นพาร์ทเนอร์เพื่อเติมพลังให้ชุมชนออกกำลังกายของคุณ",
    cta: "เป็นพาร์ทเนอร์",
  },
  {
    icon: Building2,
    title: "ออฟฟิศองค์กร",
    description: "เพิ่มพลังงานให้ทีม รองรับสั่งซื้อจำนวนมาก",
    cta: "ขอใบเสนอราคา",
  },
  {
    icon: Calendar,
    title: "ผู้จัดงานอีเวนต์",
    description: "สปอนเซอร์งานอีเวนต์ถัดไปของคุณด้วย go",
    cta: "สปอนเซอร์งาน",
  },
]
    ...
    <section id="distributors" className="relative py-16 bg-white overflow-hidden">
      <div className="max-w-7xl mx-auto px-6">
        ...
        >
          ...
          >
            ตั้งแต่งานทดลองไปจนถึงพาร์ทเนอร์องค์กร นำ go เข้าสู่โลกของคุณ
          </motion.p>
        </motion.div>
