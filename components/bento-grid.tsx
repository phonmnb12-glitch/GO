...
const features = [
  {
    icon: Zap,
    title: "75mg",
    subtitle: "คาเฟอีนจากธรรมชาติ",
    description: "พลังงานสะอาด ไม่ตกหนักเอง",
    accent: "#AFFF00",
  },
  {
    icon: Flame,
    title: "Zero",
    subtitle: "ไร้น้ำตาลเพิ่ม",
    description: "รสชาติครบ ไม่ต้องรู้สึกผิด",
    accent: "#FF6B35",
  },
  {
    icon: Brain,
    title: "100%",
    subtitle: "ความชัดเจนทางจิตใจ",
    description: "เพิ่มสมาธิและความจดจ่อในการทำงาน",
    accent: "#00D4FF",
  },
  {
    icon: Sparkles,
    title: "B12",
    subtitle: "วิตามินคอมเพล็กซ์",
    description: "สารอาหารจำเป็นเพื่อเติมเต็มพลังงาน",
    accent: "#AFFF00",
  },
]
  ...
  return (
    <section id="formula" className="relative py-16 bg-[#121212] overflow-hidden">
      ...
      <div ref={ref} className="max-w-5xl mx-auto px-6 relative z-10">
        ...
        >
          <motion.span
            className="inline-block font-mono text-[#AFFF00] text-[10px] tracking-[0.02em]"
